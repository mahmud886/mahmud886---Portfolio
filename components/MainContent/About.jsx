  ...
  return (
    <div className="mt-8">
      <p className="text-sm text-gray-600 dark:text-neutral-400">
        As a dedicated web developer with over 4 years of experience in both front-end and back-end development.
        I am passionate about continuous learning and staying up to date with the latest technologies. I have a talent
        for crafting efficient, well-designed, and notably DRY code. This has resulted in a 20%
        increase in development efficiency and a 15% reduction in debugging time.
      </p>
      <p className="mt-3 text-sm text-gray-600 dark:text-neutral-400">
        Currently, I work Nexdecade Technology (PVT) LTD, where I design template UIs, convert them into HTML and CSS,
        and
        provide comprehensive support to our users. I am passionate about crafting elegant and functional designs
